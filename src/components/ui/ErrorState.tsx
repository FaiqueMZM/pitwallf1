  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      <div className="w-12 h-12 rounded-full bg-f1-red/10 border border-f1-red/20 flex items-center justify-center mb-4">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-f1-red">
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      <div className="w-12 h-12 rounded-full bg-f1-gray/30 flex items-center justify-center mb-4">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-f1-gray-3">
          <path d="M9 9a3 3 0 114.243 4.243M9 9l6.364 6.364M9 9L3 3m6 6L3 15"
            stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      </div>
