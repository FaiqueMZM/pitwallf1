...
export async function getLatestPositions(sessionKey: number | 'latest' = 'latest'): Promise<OpenF1Position[]> {
...
export async function getDriverLaps(sessionKey: number, driverNumber: number): Promise<OpenF1Lap[]> {
...
export async function getLatestWeather(sessionKey: number | 'latest' = 'latest'): Promise<OpenF1Weather | null> {
