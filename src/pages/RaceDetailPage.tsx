...
export default function RaceDetailPage() {
  ...
  } = useRaceResults(parsedYear, parsedRound);
  const {
    data: qualifyingData,
    error: qualError,
    isLoading: qualLoading,
  } = useQualifyingResults(parsedYear, parsedRound);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === "qualifying" && (
          <>
            ...
            {qualError && (
              <ErrorState message="Couldn't load qualifying results." />
            )}
          ...
          return (
            ...
            >
              <div className="text-center mb-3 px-2">
                ...
                <p className="text-f1-gray-3 text-xs mt-1">
              ...
              <div
                ...
                style={{
                  backgroundColor: `${podiumColor}15`,
