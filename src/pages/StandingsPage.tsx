...
export default function StandingsPage() {
  ...
  const { standingsTab, setStandingsTab, selectedYear, setSelectedYear } =
    useAppStore();
          ...
          <div className="flex flex-wrap items-center gap-3">
            {leader && (
              <span className="text-f1-gray-4 text-sm">
                ...
                <span className="text-f1-red font-mono ml-2">
                  {leader.points} pts
                </span>
              </span>
            )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {standingsTab === "drivers" && (
          <>
            ...
            {driverError && (
              <ErrorState message="Couldn't load driver standings." />
            )}
        ...
        {standingsTab === "constructors" && (
          <>
            ...
            {constructorError && (
              <ErrorState message="Couldn't load constructor standings." />
            )}
        ...
        {standings.slice(0, 3).map((standing) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-f1-gray-4 text-xs mt-1">
              ...
              <div className="mt-4 pt-4 border-t border-f1-gray flex items-center justify-between">
                ...
                {gap > 0 && (
                  <span className="text-f1-gray-3 text-xs font-mono">
                    -{gap} pts
                  </span>
                )}
              </div>
...
function SeasonSelector({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="text-f1-gray-3 text-xs uppercase tracking-widest font-semibold mr-1">
        Season
      </span>
